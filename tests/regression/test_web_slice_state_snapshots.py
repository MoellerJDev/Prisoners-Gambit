...
REQUIRED_SUMMARY_ENTRY_KEYS = {"agent_id", "name", "is_player", "score", "wins", "lineage_depth", "tags", "descriptor", "genome_summary", "powerups", "lineage_relation", "survived_previous_floor", "continuity_streak", "score_delta", "wins_delta", "pressure_trend"}
